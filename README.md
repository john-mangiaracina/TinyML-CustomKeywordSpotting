...
The second notebook needs to be run in an install of Anaconda.  I have written up some documentation to get students quickly working with a local anaconda install.  (Anaconda has recently introduced a cloud based service which I have not tested, but should also work.)  This allows the user to easily define and install specific versions of Python.  The second notebook is available <a href="https://github.com/john-mangiaracina/TinyML-CustomKeywordSpotting/blob/main/4_6_8_CustomDatasetKWSModel_rev4_part2.ipynb">here.</a>
